...
--   nmap_leader('oX', obsidian_pickers.make_pick_tag('x'), 'Notes tagged #x')
-- See that file's `make_pick_tag` doc comment for available `opts`.
local obsidian_pickers = require('obsidian_pickers')

nmap_leader('oi', obsidian_pickers.make_pick_tag('project/idea', { new_from_template = true, template = "project.md" }), 'Notes tagged #project')
nmap_leader('op', obsidian_pickers.make_pick_tag('project', { new_from_template = true, template = "project.md", omit_subtags = {"done", "idea", "archived"} }), 'Notes tagged #project')
