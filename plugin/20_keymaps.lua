...
-- fo is for 'Obsidian'. Notes-by-tag pickers, implemented in
-- 'lua/obsidian_pickers.lua'. Add a new tag with one line:
--   nmap_leader('foX', obsidian_pickers.make_pick_tag('x'), 'Notes tagged #x')
-- See that file's `make_pick_tag` doc comment for available `opts`.
local obsidian_pickers = require('obsidian_pickers')

nmap_leader('foi', obsidian_pickers.make_pick_tag('project/idea', { new_from_template = true, template = "project.md" }), 'Notes tagged #project')
nmap_leader('fop', obsidian_pickers.make_pick_tag('project', { new_from_template = true, template = "project.md", omit_subtags = {"done", "idea", "archived"} }), 'Notes tagged #project')
